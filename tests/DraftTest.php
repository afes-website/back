...
class DraftTest extends TestCase {
    public function testIndexAll() {
        ...
        foreach (['blogAdmin', 'teacher'] as $key) {
            $user = User::factory()->permission($key)->create([]);
    ...
    public function testListFilter() {
        ...
        for ($i = 0; $i < $count; ++$i) {
            $exh_user = User::factory()->permission('exhibition')->create([]);
    ...
    public function testCreate() {
        ...
        $user = User::factory()->permission('blogAdmin')->create([]);
        $image = factory(Image::class)->create(['user_id' => $user->id]);
    ...
    public function testPublishFail() {
        ...
        $teacher = User::factory()->permission('teacher')->create([]);
